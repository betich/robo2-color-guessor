...
export function DrinkQuestion({ gameState, setGameState }: GameStateProps) {
    ...
    <>
        ...
        <>
          ...
          <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center">
            <p className="text-center text-4xl font-bold text-black">
              The Color of James P. Sullivan
              <br /> in Monsters&apos;s Inc
            </p>
      ...
      {!splash && (
        <>
          ...
          {gameState.infinityFuzz.drink.minty && (
            <div className="absolute bottom-[15rem] left-[22rem] flex w-36 flex-col items-center gap-y-4 p-4">
              ...
              <p className="text-center text-lg">a minty leaf (mint)</p>
            </div>
          )}

          {gameState.infinityFuzz.drink.stone && (
            <div className="absolute right-[22rem] top-[15rem] flex w-36 flex-col items-center gap-y-4 p-4">
              <Image
                src="/breakfast/stone.png"
                width={100}
                height={100}
                alt=""
              />
