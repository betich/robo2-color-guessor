...
export function LayerQuestion({ gameState, setGameState }: GameStateProps) {
    ...
    <>
      ...
      {!splash && (
        <>
          ...
          {gameState.cake.layer.amanita && (
            <div className="absolute bottom-[12rem] left-[15rem] flex w-36 flex-col items-center gap-y-4 p-4">
              <Image
          ...
          {gameState.cake.layer.star && (
            <div className="absolute bottom-[12rem] right-[16rem] flex w-36 flex-col items-center gap-y-4 p-4">
              ...
              <p className="text-center text-lg">lost peice of star (white)</p>
            </div>
          )}
